  ...
  <div className="h-full flex flex-col justify-between p-16 relative">
    ...
    <div className="relative z-10 max-w-3xl">
      ...
      <div className="space-y-1">
        ...
        <div className="text-xs text-gray-500">Науч. рук.: Евстафьева Виолетта Андреевна</div>
        <div className="text-xs text-gray-400 font-mono mt-2">ПГУТИ · г. Самара · 2026</div>
      </div>
    </div>
    ...
    <div className="flex-1 flex gap-10 items-start">
      <div className="flex-1">
        ...
        <div className="bg-gray-50 border border-gray-200 p-4 mb-4">
          ...
          <div className="font-mono text-sm text-gray-800">hash(M) → H</div>
          <div className="text-xs text-gray-400 mt-1">Любое изменение M → другой хеш H'</div>
        </div>
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex gap-3 items-start">
              <div className="w-5 h-5 bg-gray-950 text-white text-xs flex items-center justify-center font-mono flex-shrink-0 mt-0.5">{i + 1}</div>
          ...
          {[
            ...
            <div key={item.label} className="border border-gray-200 p-3 space-y-1">
              <div className="flex items-center gap-2">
                <Icon name={item.icon} size={12} className="text-gray-500" />
                <span className="text-xs font-mono text-gray-500 uppercase tracking-wider">{item.label}</span>
              </div>
              <div className="text-xs font-mono text-gray-800">{item.desc}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.name} className="border border-gray-200 p-3 grid grid-cols-3 gap-2 items-center">
              <div>
                <div className="text-xs font-mono font-semibold text-gray-900">{item.name}</div>
                <div className="text-xs text-gray-400 font-mono">{item.bits}</div>
              </div>
              <div className="text-xs text-gray-500">{item.use}</div>
              <div className={`text-xs font-mono text-right ${item.ok ? "text-green-600" : "text-red-500"}`}>{item.status}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.name} className="border border-gray-200 p-3 grid grid-cols-3 gap-2 items-center">
              ...
              <div className="text-xs text-gray-500">{item.use}</div>
              <div className="text-xs font-mono text-right text-blue-600">{item.status}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {[
        ...
        <div key={card.title} className="border border-gray-200 h-full flex flex-col">
          <div className="border-b border-gray-200 p-4 flex items-center gap-3">
            <Icon name={card.icon} size={16} className="text-gray-500" />
        ...
        <div className="space-y-1.5">
          {[
            ...
            <div key={r.risk} className="flex justify-between items-center border border-red-100 bg-red-50 px-3 py-2">
              <span className="text-xs text-gray-700">{r.risk}</span>
              <span className="text-xs text-red-600 font-mono">{r.prob}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="space-y-1.5">
          {[
            ...
            <div key={r.risk} className="flex justify-between items-center border border-green-100 bg-green-50 px-3 py-2">
              <span className="text-xs text-gray-700">{r.risk}</span>
              <span className="text-xs text-green-700 font-mono">{r.prob}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex-1 space-y-4">
        ...
        {[
          ...
          <div key={item.n} className="flex gap-4 border-l-2 border-gray-200 pl-4">
            <div className="text-lg font-mono text-gray-200 font-bold flex-shrink-0">{item.n}</div>
